...
/**
 * Created by stognacci on 15/03/2016.
 */
public class FriendsContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.stognacci.friends.provider";
    ...
    public static class Friends implements FriendsColumns, BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd." + CONTENT_AUTHORITY + "." + PATH_FRIENDS;
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd." + CONTENT_AUTHORITY + "." + PATH_FRIENDS;
